...
def run_discrete(environment_name, mapping, shape=None):
    ...
    print ('Iterations:', iters, 'Time:', end_time1)
    #print('value_policy',value_policy)
    # print

    print ('== Policy Iteration ==')
    start_time1 = time.time()
    policy, iters = policy_iteration(problem)
    end_time2 = time.time() - start_time1
    print ('Iterations:', iters,'Time:', end_time2)
    # print
